...
#import "TAPageAbstractDotView.h"
#import "TAPageAnimatedDotView.h"
#import "TAPageDotView.h"
...
@implementation TAPageController
...
- (void)initialization
{
    self.dotViewClass           = [TAPageAnimatedDotView class];
...
{
    if (self.dotViewClass) {
        TAPageAbstractDotView *abstractDotView = (TAPageAbstractDotView *)[self.dots objectAtIndex:index];
        if ([abstractDotView respondsToSelector:@selector(changeActivityState:)]) {
            [abstractDotView changeActivityState:active];
        } else {
            NSLog(@"Custom view : %@ must implement an 'changeActivityState' method or you can subclass %@ to help you.", self.dotViewClass, [TAPageAbstractDotView class]);
        }
