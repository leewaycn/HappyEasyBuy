...
@implementation HEBConfiguration
...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarTintColor = UIColorHex(#9e9e9e);                                              // NavBarTintColor : UINavigationBar 的 tintColor，也即导航栏上面的按钮颜色
    QMUICMI.navBarTitleColor = UIColorBlack;                                    // NavBarTitleColor : UINavigationBar 的标题颜色，以及 QMUINavigationTitleView 的默认文字颜色
    QMUICMI.navBarTitleFont = UIFontMake(20);                                              // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
...
#pragma mark - TabBar
    ...
    QMUICMI.tabBarItemTitleColor = UIColorHex(#9e9e9e);                                         // TabBarItemTitleColor : 未选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleColorSelected = BASECOLOR;                     // TabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
