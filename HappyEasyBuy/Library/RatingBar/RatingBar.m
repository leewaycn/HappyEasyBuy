...
-(void)setImageDeselected:(NSString *)deselectedName halfSelected:(NSString *)halfSelectedName fullSelected:(NSString *)fullSelectedName andDelegate:(id<RatingBarDelegate>)delegate{
    ...
    [_s2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.mas_centerY);
        make.left.equalTo(_s1.mas_right).offset(2.5);
        make.height.equalTo(self.mas_height);
        make.width.equalTo(self.mas_width).multipliedBy(0.2);
    }];
    ...
    [_s3 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.mas_centerY);
        make.left.equalTo(_s2.mas_right).offset(2.5);
        make.height.equalTo(self.mas_height);
        make.width.equalTo(self.mas_width).multipliedBy(0.2);
    }];
    ...
    [_s4 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.mas_centerY);
        make.left.equalTo(_s3.mas_right).offset(2.5);
        make.height.equalTo(self.mas_height);
        make.width.equalTo(self.mas_width).multipliedBy(0.2);
    }];
    ...
    [_s5 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(self.mas_centerY);
        make.left.equalTo(_s4.mas_right).offset(2.5);
        make.height.equalTo(self.mas_height);
        make.width.equalTo(self.mas_width).multipliedBy(0.2);
    }];
